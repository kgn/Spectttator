...
/** Most dribbble api calls take page and per_page to define which page of 
 ...
 pagination dictionary to pass to methods. Secondly it provides an object that is passed to block, 
...
/** 
 ...
 methods use these to return pagination data to blocks.
...
/** 
 Returns a `SPPagination` object initialized with the given pagination data. 
